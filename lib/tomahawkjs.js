...
var _reportCapabilities = function (capabilities) {
    this.capabilities = [];
    if ((1 & capabilities) !== 0) {
...
var _hasCapability = function (capability) {
...
var _getInstance = function (cb) {
    ...
    fs.readFile(path.resolve(__dirname, 'tomahawk-desktop', 'tomahawk.js'), 'UTF-8', function (err, data) {
        ...
        context.Tomahawk.reportCapabilities = _reportCapabilities;
        context.hasCapability = _hasCapability;
